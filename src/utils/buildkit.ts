...
export async function formatDockerfileForBuildkit(dockerfilePath: string, fromSrcToDstPairs: {src: string; dst: string}[], baseDir: string, targetBuildStage: string) {
...
async function convertDockerfileToBuildkitFormat(dockerfilePath: string, fromSrcToDstPairs: {src: string; dst: string}[], baseDir: string, targetBuildStage: string) {
