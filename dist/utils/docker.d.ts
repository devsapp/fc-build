...
export declare function generateDockerEnvs({ region, baseDir, credentials, serviceName, serviceProps, functionName, functionProps, }: IDockerEnvs, userCustomEnv: any): Promise<any>;
interface IMount {
    Type: string;
    Source: string;
    Target: string;
...
export declare function generateDockerfileEnvs(credentials: ICredentials, region: string, baseDir: string, serviceProps: IServiceProps, functionProps: IFunctionProps, customEnv: any): Promise<any[]>;
export declare function copyFromImage(imageName: any, from: any, to: any): Promise<void>;
export declare function displaySboxTips(codeUri: any, useSandbox: any): void;
export declare function startSboxContainer(opts: any): Promise<void>;
export {};
